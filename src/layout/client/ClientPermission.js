                ...
                <Hyperlink linkDefault={true}>
                    <View style={styles.permission}>
                        <View style={styles.titleBar}>
                            ...
                            <Text style={styles.text}>These Terms of Use (“Terms” or “Agreement”) established by BookSmart Technologies LLC, a New York Limited Liability Company, (hereinafter BOOKSMART™) are set forth below and agreed to by You, assigns, and third party beneficiaries (collectively “You”), and govern your access to use of BOOKSMART’s provisions of services (described below), effective and agreed to by You as of the date You click “Accept,” first access or use BOOKSMART™, or otherwise indicate your assent to the Terms (“Effective Date”). By clicking “Accept” or otherwise using BOOKSMART™, You agree to bound to the Terms set forth below.</Text>
                        </View>
                        <View style={styles.titleBar}>
                        ...
                        <View style={styles.titleBar}>
                            ...
                            <Text style={[styles.text, {marginTop: 0, marginBottom: 20}]}><Text style={{fontWeight: 'bold'}}>(d) Cancellation Policy. </Text>If you cancel a shift, you will not be able to apply to any shift that overlaps with the shift you canceled.</Text>
                        ...
                        <View style={styles.titleBar}>
                            ...
                            <Text style={styles.text}><Text style={{fontWeight: 'bold'}}>(a) Hourly Rate. </Text>Rates of pay are different per client and discipline. You will be required to sign our Rate of Pay Acknowledgment Form.</Text>
                            <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(b) Payment of Fees. </Text>For each Completed Shift that You perform, You will receive from BOOKSMART™ agreed upon payment rate for each hour performed less the Service Fee no later than the following Friday; in most cases the next business day if that shift was verified. You will enter current bank account information, and You agree that our BOOKSMART™ third-party payment processor and BOOKSMART™ may transfer to such bank account the Fees owed, with respect to each Completed Service that You perform. You, not BOOKSMART™, are solely responsible for the accuracy of all bank account information, including the bank account number and bank routing information. BOOKSMART™ hereby disclaims all liability related to errors in fund deposits due to inaccurate or incomplete bank account information.</Text>
                            <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(c) Taxes. </Text>You are solely responsible for all tax returns and payments required to be filed with or made to any federal, state, or local tax authority in connection to performance of Services. Users of BOOKSMART™ are exclusively liable for complying with all applicable federal, state, and local laws, including social security laws governing self-employed individuals. Furthermore, users are exclusively liable for complying with all laws related to payment of taxes, social security, disability, and other contributions based on fees paid to You by BOOKSMART™ in connection with a Completed Service or otherwise received by You through the Service. BOOKSMART™ will not withhold or make payments for taxes, social security, unemployment insurance or disability insurance contributions. BOOKSMART™ will not obtain workers’ compensation insurance (except as described below) on Caregiver’s behalf. Users hereby agree to indemnify and defend BOOKSMART™ against any and all such taxes or contributions, including penalties, interest, attorneys’ fees and expenses. BOOKSMART™ does not offer tax advice to Users.</Text>
                            <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(d) Fee Bonus. </Text>I/Cs will receive a 50% Fee Bonus for all hours worked over 40 hours at one facility in any given week. The time cannot be split across multiple facilities. I/Cs shall also receive a 50% Fee Bonus for each hour worked on: New Years Day, Easter Sunday (where applicable - at client’s sole discretion) , Memorial Day (where applicable at client’s sole discretion), Independence Day, Labor Day, Thanksgiving Day, and Christmas. The 50% Bonus does not compound so if the holiday falls on a weekend it will not be counted twice.</Text>
                            <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(e) Insurance. </Text>I/Cs using BOOKSMART™ are required to carry Workplace Safety Insurance and Liability Insurance coverage to perform Services for any Client. BOOKSMART™ has Workplace Safety Insurance in place through accredited insurance carriers as well as Independent Contractor Liability Insurance (Collectively “Insurance”) for you to enroll in and take advantage of. Applicants will need to list themselves with this Insurance coverage from the BOOKSMART™ insurance carrier(s). This is included on the enrollment form.</Text>
                        </View>
                        <View style={styles.titleBar}>
                        ...
                        <View style={styles.titleBar}>
                            <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}>IMPORTANT! BE SURE YOU HAVE SCROLLED THROUGH AND CAREFULLY READ ALL of the above Terms and Conditions of this Agreement before electronically signing and/or clicking an “Agree” or similar button and/or USING THE SITE (“acceptance”). This Agreement is legally binding between you and BOOKSMART. By electronically signing and/or clicking an “Agree” or similar button and/or using the SITE, you AFFIRM THAT YOU ARE OF THE LEGAL AGE OF 18 AND NOT OVER 70 YEARS OLD AND HAVE THE LEGAL CAPACITY TO ENTER INTO THIS AGREEMENT and you agree to abide by all of the Terms and Conditions stated or referenced herein. If you do not agree to abide by these Terms and Conditions, do not electronically sign and/or click an “Agree” or similar button and do not use the SITE. You must accept and abide by these Terms and Conditions in the Service Terms as presented to you.</Text>
                        </View>
                        <View style={styles.titleBar}>
