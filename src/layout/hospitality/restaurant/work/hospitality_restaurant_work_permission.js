          ...
          <Hyperlink linkDefault={true}>
            <View style={styles.permission}>
              ...
              <View style={styles.titleBar}>
                ...
                <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(b) Taxes. </Text>
                You are solely 
              ...
              <View style={styles.titleBar}>
                <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>5. Safety & Work-Related Injury Policy. </Text>Safety is a top priority. Each I/C is expected to obey general safety rules and exercise caution and common sense in all work activities.</Text>
