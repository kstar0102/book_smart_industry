          ...
          <Hyperlink linkDefault={true}>
            <View style={styles.permission}>
              <View style={styles.titleBar}>
                ...
                <Text style={styles.text}>These Terms of Use (“Terms” or “Agreement”) established by BookSmart Technologies LLC, a New York Limited Liability Company, (hereinafter BOOKSMART™) are set forth below and agreed to by You, assignees, and third party beneficiaries (collectively “You”), and govern Your access to use of BOOKSMART’s provisions of services (described below), effective and agreed to by You as of the date You click “Accept,” first access or use BOOKSMART™, or otherwise indicate Your assent to the Terms (“Effective Date”). By clicking “Accept” or otherwise using BOOKSMART™, You agree to bound to the Terms set forth below.</Text>
              </View>
              <View style={styles.titleBar}>
              ...
              <View style={styles.titleBar}>
                ...
                <Text style={[styles.text, {marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(e) No Authorization. </Text>Users of BOOKSMART™ Services acknowledge and agree that they are not the agent or representative of BOOKSMART™ and are not authorized to make any representation, contract or commitment on behalf of BOOKSMART™.</Text>
              ...
              <View style={styles.titleBar}>
                ...
                <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(b) Taxes. </Text>You are solely responsible for all tax returns and payments required to be filed with or made to any federal, state, or local tax authority in connection to performance of Services. Users of BOOKSMART™ are exclusively liable for complying with all applicable federal, state, and local laws, including social security laws governing self-employed individuals. Furthermore, users are exclusively liable for complying with all laws related to payment of taxes, social security, disability, and other contributions based on fees paid to You by BOOKSMART™ in connection with a Completed Service or otherwise received by You through the Service. BOOKSMART™ will not withhold or make payments for taxes, social security, unemployment insurance or disability insurance contributions. BOOKSMART™ will not obtain workers’ compensation insurance (except as described below) on I/Cs behalf. Users hereby agree to indemnify and defend BOOKSMART™ against any and all such allegations or actions related to taxes or contributions, including penalties, interest, attorneys’ fees and expenses. BOOKSMART™ does not offer tax advice to Users.</Text>
                <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(c) Fee Bonus. </Text>I/Cs will receive a 50% Fee Bonus for all hours worked in excess of 40 hours <Text style={{fontWeight: 'bold'}}>at one facility</Text> in any given week. <Text style={{fontWeight: 'bold'}}>The time cannot be split across multiple facilities.</Text> I/Cs shall also receive a 50% Fee Bonus for each hour worked on: New Years Day, Easter Sunday, Memorial Day, Independence Day, Labor Day, Thanksgiving Day, and Christmas. <Text style={{fontWeight: 'bold'}}>The 50% Bonus does not compound so if the holiday falls on a weekend it will not be counted twice.</Text></Text>
                <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(d) Insurance. </Text>I/Cs using BOOKSMART™ are required to carry Workplace Safety Insurance and Liability Insurance coverage in order to perform Services for any Client. BOOKSMART™ has Workplace Safety Insurance in place through accredited insurance carriers as well as Independent Contractor Liability Insurance (Collectively “Insurance”) for You to enroll in and take advantage of. Applicants will need to enroll themselves with this Insurance coverage from BOOKSMART™ insurance carrier(s) prior to commencing any shifts.</Text>
                <Text style={[styles.text, {fontWeight: 'bold', marginTop: 0}]}><Text style={{fontWeight: 'bold'}}>(e) Service Fee. </Text>By accessing/using BOOKSMART™ You consent and agree to these terms:</Text>
              </View>
              <View style={styles.titleBar}>
                <Text style={styles.subTitle}>3. Registration Information.</Text>
                <Text style={[styles.text, { marginBottom: 20 }]}><Text style={{fontWeight: 'bold'}}>(a) Maintaining Accuracy. </Text>You represent and warrant that: any license numbers (“Licenses”) You provide BOOKSMART™ is Your Registration Information or otherwise are valid; such License(s) will remain in full force for the duration of time in which You submit Service Applications for Service Requests requiring any such License(s); and You will notify BOOKSMART™ and all Clients that You have agreed to perform future Services for if You: (i) become suspended or barred from working in any jurisdiction, (ii) lose any of Your License(s), (iii) are facing disciplinary actions, including suspension, or (iv) make any changes to Your Registration Information.</Text>
